package com.personal.salary.kotlin.widget
...
import com.personal.salary.kotlin.ui.activity.ImageSelectActivity
import com.personal.salary.kotlin.ui.activity.VideoSelectActivity
import com.personal.salary.kotlin.ui.dialog.InputDialog
import com.personal.salary.kotlin.ui.dialog.MessageDialog
import com.personal.salary.kotlin.ui.dialog.TipsDialog
            ...
            if ((mimeTypes != null) && (mimeTypes.isNotEmpty()) && !TextUtils.isEmpty(mimeTypes[0])) {
                ...
                if (mimeTypes.size == 1) {
                    when (mimeTypes[0]) {
                        ...
                        "video/*" -> {
                            VideoSelectActivity.start(activity, if (multipleSelect) Int.MAX_VALUE else 1, object :
