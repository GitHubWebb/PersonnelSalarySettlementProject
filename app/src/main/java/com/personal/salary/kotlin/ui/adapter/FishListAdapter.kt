...
import com.personal.salary.kotlin.databinding.FishListItemBinding
...
class FishListAdapter(private val adapterDelegate: AdapterDelegate, private val expandContent: Boolean = false) :
    ...
    inner class FishListViewHolder(val binding: FishListItemBinding) : RecyclerView.ViewHolder(binding.root) {

        constructor(parent: ViewGroup) : this(parent.asViewBinding<FishListItemBinding>())
