...
import com.personal.salary.kotlin.ktx.doScrollStateChanged
import com.personal.salary.kotlin.other.GridSpaceDecoration
import com.personal.salary.kotlin.ui.adapter.VideoSelectAdapter
import com.personal.salary.kotlin.ui.dialog.AlbumDialog
    ...
    override fun onClick(view: View) {
        when (view.id) {
            R.id.fab_video_select_floating -> {
                if (selectVideo.isEmpty()) {
                    // 点击拍照
                    CameraActivity.start(this, true, object : CameraActivity.OnCameraListener {
